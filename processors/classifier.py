...
CATEGORY_KEYWORDS = {
    ...
    "ai_industry": {
        ...
        "keywords": [
            ...
            "视频世界模型", "生成式世界模型", "交互式世界模型",
            "Sora", "视频生成", "物理仿真", "物理引擎", "3D场景理解", "环境建模",
            "动态预测", "因果推理", "状态预测",
            "Cosmos", "NVIDIA Cosmos", "英伟达Cosmos",
            "具身智能", "Embodied AI", "人形机器人", "仿生机器人", "机器人",
            "四足机器人", "机器狗", "机械臂", "协作机器人", "工业机器人", "服务机器人",
            "灵巧手", "伺服电机", "减速器", "谐波减速器", "RV减速器",
            "AI硬件", "AI相机", "AI摄像头", "跟踪",
            "OBSBOT", "寻影", "大疆", "DJI", "影石", "Insta360",
            "融资", "收购", "上市", "估值", "IPO",
            "商业化", "产品发布", "用户增长", "市场份额",
            "芯片", "GPU", "NPU", "算力", "云服务", "AI芯片",
            "宇树科技", "智元机器人", "傅利叶智能", "优必选", "波士顿动力",
            "Figure AI", "Agility Robotics", "特斯拉Optimus", "Optimus",
        ],
    },
    "ad_tech": {
        "name": "智能驾驶技术",
    ...
    "ai_tech": {
        ...
        "keywords": [
            ...
            "动态预测", "因果推理", "状态预测",
            "Cosmos", "NVIDIA Cosmos", "英伟达Cosmos",
            "具身智能", "Embodied AI", "VLA", "视觉-语言-动作",
            "人形机器人", "仿生机器人", "四足机器人", "机器狗",
            "机械臂", "协作机器人", "工业机器人", "服务机器人",
            "灵巧手", "运动控制", "运动规划", "轨迹规划",
            "感知融合", "多模态感知", "ROS", "ROS2", "SLAM",
            "伺服电机", "减速器", "谐波减速器", "RV减速器", "力矩传感器",
        ],
    },
}
